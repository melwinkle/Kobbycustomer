create schema bethelproperties;

use bethelproperties;
...
-- User_photo , user_level,stats) VALUES ("Kwabena",
-- "Koranteng", "kwabenakoranteng5@gmail.com","d033e22ae348aeb5660fc2140aec35850c4da997"
-- ,'no_image.png',1,1);
...
INSERT INTO tenant(FirstName, LastName, type_of_business
, contact_number,Name_of_the_shop,property_id,`status`,`address`) VALUES("desire","dane","Saloon",
"02031231231","Zodin wig shop",1,1,'No 1 street East Legon');
